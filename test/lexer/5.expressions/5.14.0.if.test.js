...
test("5.14.0.if", async () => {
  ...
  expect(lex(code)).toEqual([
    ...
    { variant: 'KeywordToken', value: 'print' },
    { variant: 'DelimiterToken', value: '(' },
    { variant: 'LiteralToken', type: "String", value: 'Hello, condition1!' },
    { variant: 'DelimiterToken', value: ')' },
    { variant: 'DelimiterToken', value: ';' },
    ...
    { variant: 'KeywordToken', value: 'print' },
    { variant: 'DelimiterToken', value: '(' },
    { variant: 'LiteralToken', type: "String", value: 'Hello, condition2!' },
    { variant: 'DelimiterToken', value: ')' },
    { variant: 'DelimiterToken', value: ';' },
    { variant: 'KeywordToken', value: 'else' },
    { variant: 'KeywordToken', value: 'print' },
    { variant: 'DelimiterToken', value: '(' },
    { variant: 'LiteralToken', type: "String", value: 'Hello, other!' },
    { variant: 'DelimiterToken', value: ')' },
    { variant: 'DelimiterToken', value: ';' },
    { variant: 'KeywordToken', value: 'end' }
  ]);
